$((function() {
    ...
    function truncateTexts() {
        $(".js-truncate-text").each(function() {
            const $this = $(this);
            $this.text( truncateString($this.text(), $this.data('truncateLength')) );
        });
        $(".js-truncate-text-and-show-more").each(function() {
            const $this = $(this);
            const text = $this.text();
            const truncateLength = $this.data('truncateLength');
    ...
    $(".js-show-full-product-desc").on("click", (function() {
        ...
        $textContainer.removeClass('text-block--partially-hidden');
